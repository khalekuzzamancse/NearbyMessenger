...
fun NearByDevices(
    ...
    onConversionScreenRequest: (ScannnedDevice) -> Unit,
) {
    var clickedDevice by remember { mutableStateOf<ScannnedDevice?>(null) }
    val onDetailsDismiss: () -> Unit = {
        clickedDevice = null
    }
    var showDisconnectConfirmDialog by remember { mutableStateOf(false) }
    var disconnectedDevice by remember { mutableStateOf<ScannnedDevice?>(null) }
